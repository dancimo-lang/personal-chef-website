    ...
    <div className="min-h-screen" style={{backgroundColor: '#f5f2e8'}}>
      ...
      <section className="relative min-h-[60vh] md:h-[75vh] lg:h-[85vh] xl:h-[85vh] flex items-center justify-center">
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          {/* Logo in center */}
          <div className="mb-6 md:mb-8 xl:mb-6">
            <Image
              src="/images/planted slo Logo v2.png"
              alt="PLANTED SLO Logo"
              width={320}
              height={320}
              className="w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-56 xl:h-56 mx-auto"
              priority
            />
          </div>
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-lg mb-8 md:mb-12 xl:mb-8 max-w-3xl mx-auto leading-relaxed text-center px-4" style={{color: '#d7e1c7', textShadow: '0 0 2px rgba(0,0,0,0.8), 0 0 4px rgba(0,0,0,0.6), 0 0 8px rgba(0,0,0,0.4)'}}>
      ...
      {/* Services Section */}
      <section id="services-section" className="py-6 md:py-8 lg:py-12 xl:py-8" style={{backgroundColor: '#d7e1c7'}}>
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-4xl font-bold text-center mb-8 md:mb-12 lg:mb-16 xl:mb-10" style={{color: '#002b00'}}>
            Personal Chef Services
          </h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 md:gap-8 lg:gap-8 xl:gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              <Link href="/private-dinners" className="block">
                <div className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-64 lg:h-64 xl:w-56 xl:h-56 rounded-lg overflow-hidden flex items-center justify-center mx-auto mb-4 border-4 hover:opacity-80 transition-opacity cursor-pointer" style={{borderColor: '#002b00'}}>
                  <Image
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-2xl font-semibold mb-3" style={{color: '#002b00'}}>Private Dinners</h3>
              </Link>
            </div>
            <div className="text-center">
              <Link href="/meal-prep-services" className="block">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-2xl font-semibold mb-4" style={{color: '#002b00'}}>Meal Prep</h3>
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-16 lg:py-20 xl:py-14" style={{backgroundColor: '#e8f5e8'}}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-3xl font-bold mb-6" style={{color: '#002b00'}}>
            From Passion to Profession
          </h2>
          <p className="text-base sm:text-lg md:text-lg lg:text-lg xl:text-base mb-8 max-w-2xl mx-auto" style={{color: '#002b00'}}>
      ...
      {/* Testimonials */}
      <section className="py-12 md:py-16 lg:py-20 xl:py-14" style={{backgroundColor: '#d7e1c7'}}>
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-3xl font-bold text-center mb-8 md:mb-12 lg:mb-16 xl:mb-10" style={{color: '#002b00'}}>
            What Clients Say
          </h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 md:gap-8 lg:gap-8 xl:gap-6">
            <div className="bg-white p-4 md:p-6 lg:p-6 xl:p-5 rounded-lg shadow-lg">
              <p className="text-sm sm:text-base md:text-base lg:text-base xl:text-sm text-gray-800 mb-4">
              ...
              <p className="font-semibold text-sm sm:text-base md:text-base lg:text-base xl:text-sm" style={{color: '#4a7c4e'}}>- Sarah & Michael</p>
            </div>
            <div className="bg-white p-4 md:p-6 lg:p-6 xl:p-5 rounded-lg shadow-lg">
              <p className="text-sm sm:text-base md:text-base lg:text-base xl:text-sm text-gray-800 mb-4">
              ...
              <p className="font-semibold text-sm sm:text-base md:text-base lg:text-base xl:text-sm" style={{color: '#4a7c4e'}}>- Jennifer L.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 lg:py-20 xl:py-14" style={{backgroundColor: '#4a7c4e'}}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-3xl font-light mb-6" style={{color: '#d7e1c7'}}>
