  ...
  return (
    <div className="min-h-screen" style={{backgroundColor: '#f5f2e8'}}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4">
        <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-3xl font-bold mb-2" style={{color: '#002b00'}}>About Me</h1>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 xl:gap-8 items-center mb-8 md:mb-10 lg:mb-12 xl:mb-8 justify-center">
          <div className="prose prose-lg max-w-none">
            <p className="text-base sm:text-lg md:text-lg lg:text-lg xl:text-base mb-6" style={{color: '#002b00'}}>
          ...
          <div className="relative flex justify-center">
            <Image
              ...
              width={500}
              height={500}
              className="w-[65%] sm:w-[70%] md:w-[72%] lg:w-[72%] xl:w-[68%] h-auto rounded-lg shadow-lg"
            />
          </div>
        </div>
      </div>
