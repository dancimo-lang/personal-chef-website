  ...
  return (
    <nav className="shadow-md sticky top-0 z-50" style={{backgroundColor: '#d7e1c7'}}>
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              ...
              <div 
                className={`absolute top-full left-0 mt-1 w-48 rounded-lg shadow-lg transition-all duration-200 ${
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 border-t" style={{borderColor: '#002b00', backgroundColor: '#d7e1c7'}}>
              <Link 
                href="/" 
                className="transition-colors font-medium hover:opacity-80"
              ...
              <button
                ...
                className="transition-colors font-medium hover:opacity-80 flex items-center space-x-1 w-full text-left"
                style={{color: '#002b00'}}
              >
                Services
              ...
              <Link 
                ...
                onClick={() => setIsOpen(false)}
                style={{color: '#002b00', backgroundColor: 'transparent', border: '1px solid #002b00'}}
              >
                Book Now
              </Link>
            </div>
